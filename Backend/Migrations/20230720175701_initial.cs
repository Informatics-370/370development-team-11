        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Procurement_Details_Budget_Line_Account_Code_Budget_ID_Category_ID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 10000.0, new DateTime(2023, 7, 20, 19, 57, 1, 454, DateTimeKind.Local).AddTicks(3876) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 8, "Please ensure all submitted information is correct.", "Procurement Request Has Been Accepted" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "$2a$11$8KtW4ac2wMD4NF2g6girz.7Je4F2Z/LVuhLA.D/S5s2Skn748XEqC", "test", 2, "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", "Demo", "079 373 1393", "moyoemailservice@gmail.com", 1 });

            migrationBuilder.InsertData(
                table: "Procurement_Request",
                columns: new[] { "Procurement_Request_ID", "Description", "Name", "Requisition_Status_ID", "User_ID", "Vendor_ID" },
                values: new object[] { 1, "A new company procurement request", "Procurement Request for x", 3, 1, 1 });

            migrationBuilder.InsertData(
                table: "Procurement_Request_Quote",
                columns: new[] { "Quote_ID", "Path", "Procurement_Request_ID" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_Account_Code_Budget_ID_Category_ID",
