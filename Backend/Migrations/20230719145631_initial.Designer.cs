...
namespace ProcionAPI.Migrations
{
    ...
    [Migration("20230719145631_initial")]
            ...
            modelBuilder.Entity("ProcionAPI.Models.Entities.Mandate_Limit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Mandate_ID = 1,
                            Ammount = 10000.0,
                            Date = new DateTime(2023, 7, 19, 16, 56, 30, 804, DateTimeKind.Local).AddTicks(7549)
                        });
                });
            ...
            modelBuilder.Entity("ProcionAPI.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            User_Id = 1,
                            Password = "$2a$11$lsfx1J67SMyE.3CDhZ5vBeTB3/d2a5MEZ.MLicffVzMamT0/2iYZC",
