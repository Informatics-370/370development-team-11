...
namespace ProcionAPI.Migrations
{
    ...
    [Migration("20230816144143_initial")]
            ...
            modelBuilder.Entity("ProcionAPI.Models.Entities.Mandate_Limit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Mandate_ID = 1,
                            Ammount = 10000.0,
                            Date = new DateTime(2023, 8, 16, 16, 41, 43, 367, DateTimeKind.Local).AddTicks(6077)
                        });
                });
            ...
            modelBuilder.Entity("ProcionAPI.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Access_ID = 1,
                            No_Notifications = 0,
                            Password = "$2a$11$Ju0RyjRF3hnV9CPFbChgeOn/aUiICE7nVcXEz2ALtSG/GQejVlZr2",
