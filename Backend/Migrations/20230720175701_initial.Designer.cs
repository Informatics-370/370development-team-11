...
namespace ProcionAPI.Migrations
{
    ...
    [Migration("20230720175701_initial")]
            ...
            modelBuilder.Entity("ProcionAPI.Models.Entities.Mandate_Limit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Mandate_ID = 1,
                            Ammount = 10000.0,
                            Date = new DateTime(2023, 7, 20, 19, 57, 1, 454, DateTimeKind.Local).AddTicks(3876)
                        });
                });
            ...
            modelBuilder.Entity("ProcionAPI.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            User_Id = 1,
                            Password = "$2a$11$8KtW4ac2wMD4NF2g6girz.7Je4F2Z/LVuhLA.D/S5s2Skn748XEqC",
