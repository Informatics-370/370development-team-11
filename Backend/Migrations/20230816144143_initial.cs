        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanAccInv = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanAccFin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanAccPro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanAccVen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanAccRep = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanViewPenPro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanViewFlagPro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanViewFinPro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanAppVen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanEditVen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanDeleteVen = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "Vendor_Insurance_Type",
                columns: table => new
                {
                    Vendor_Insurance_Type_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vendor_Insurance_Type", x => x.Vendor_Insurance_Type_ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    No_Notifications = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_User", x => x.User_Id);
                    table.ForeignKey(
                        name: "FK_User_Access_Access_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferedVendor = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "Consumable_History",
                columns: table => new
                {
                    History_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Consumable_ID = table.Column<int>(type: "int", nullable: false),
                    StockAmt = table.Column<int>(type: "int", nullable: false),
                    DateCaptured = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Consumable_History", x => x.History_ID);
                    table.ForeignKey(
                        name: "FK_Consumable_History_Consumable_Consumable_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Budget_Line", x => x.BudgetLineId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bank_Stamped_Confirtmation = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Due_Dillegence", x => x.Due_Diligence_ID);
                    table.ForeignKey(
                        name: "FK_Due_Dillegence_Vendor_Vendor_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurement_Request_User_User_ID",
                        column: x => x.User_ID,
                        principalTable: "User",
                        principalColumn: "User_Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendor_Asset_Asset_Asset_ID",
                        column: x => x.Asset_ID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BEE_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Vendor_ID = table.Column<int>(type: "int", nullable: false),
                    BEE_Level = table.Column<int>(type: "int", nullable: false),
                    BEE_Certificate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vendor_BEE", x => x.BEE_ID);
                    table.ForeignKey(
                        name: "FK_Vendor_BEE_Vendor_Vendor_ID",
                        column: x => x.Vendor_ID,
                        principalTable: "Vendor",
                        principalColumn: "Vendor_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vendor_Consumable", x => new { x.Vendor_Consumbale_ID, x.Consumable_ID, x.Vendor_ID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vendor_Consumable_Vendor_Vendor_ID",
                        column: x => x.Vendor_ID,
                        principalTable: "Vendor",
                        principalColumn: "Vendor_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendor_Insurance_Vendor_Insurance_Type_Vendor_Insurance_Type_ID",
                        column: x => x.Vendor_Insurance_Type_ID,
                        principalTable: "Vendor_Insurance_Type",
                        principalColumn: "Vendor_Insurance_Type_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vendor_Insurance_Vendor_Vendor_ID",
                        column: x => x.Vendor_ID,
                        principalTable: "Vendor",
                        principalColumn: "Vendor_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_Id = table.Column<int>(type: "int", nullable: false),
                    Admin_ID = table.Column<int>(type: "int", nullable: false),
                    DelegationStatus_ID = table.Column<int>(type: "int", nullable: false),
                    ...
                    DelegatingParty = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Delegation_Of_Authority_Delegation_Status_DelegationStatus_ID",
                        column: x => x.DelegationStatus_ID,
                        principalTable: "Delegation_Status",
                        principalColumn: "Status_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Procurement_Details_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeID = table.Column<int>(type: "int", nullable: false),
                    Procurement_Request_ID = table.Column<int>(type: "int", nullable: false),
                    Sign_Off_Status_ID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Procurement_Details", x => x.Procurement_Details_ID);
                    table.ForeignKey(
                        name: "FK_Procurement_Details_Budget_Line_BudgetLineId",
                        column: x => x.BudgetLineId,
                        principalTable: "Budget_Line",
                        principalColumn: "BudgetLineId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurement_Details_Employee_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employee",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurement_Details_Payment_Method_Payment_Method_ID",
                        column: x => x.Payment_Method_ID,
                        principalTable: "Payment_Method",
                        principalColumn: "Payment_Method_ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurement_Details_Procurement_Payment_Status_Procurement_Payment_Status_ID",
            ...
            migrationBuilder.CreateTable(
                name: "Procurement_Request_Quote",
                columns: table => new
                {
                    ...
                    PrefferedQuote = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Procurement_Request_Quote", x => x.Quote_ID);
                    table.ForeignKey(
                        name: "FK_Procurement_Request_Quote_Procurement_Request_Procurement_Request_ID",
                        column: x => x.Procurement_Request_ID,
                        principalTable: "Procurement_Request",
                        principalColumn: "Procurement_Request_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    License_No = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Vendor_Detail_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Company_Registration_Number = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Vendor_Detail_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Income_Tax_Num = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Vendor_Detail_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Vat_Registration_Number = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Vendor_Detail_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Procurement_Deposit_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Procurement_Details_ID = table.Column<int>(type: "int", nullable: false),
                    Deposit_Due_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Deposit_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Amount_Outstanding = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deposit", x => x.Procurement_Deposit_ID);
                    table.ForeignKey(
                        name: "FK_Deposit_Procurement_Details_Procurement_Details_ID",
                        column: x => x.Procurement_Details_ID,
                        principalTable: "Procurement_Details",
                        principalColumn: "Procurement_Details_ID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payment_Made_Procurement_Details_Procurement_Details_ID",
                        column: x => x.Procurement_Details_ID,
                        principalTable: "Procurement_Details",
                        principalColumn: "Procurement_Details_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Procurement_Asset", x => new { x.Procurement_Asset_ID, x.Procurement_Details_ID, x.Asset_ID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurement_Asset_Procurement_Details_Procurement_Details_ID",
                        column: x => x.Procurement_Details_ID,
                        principalTable: "Procurement_Details",
                        principalColumn: "Procurement_Details_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Procurement_Consumable_Procurement_Details_Procurement_Details_ID",
                        column: x => x.Procurement_Details_ID,
                        principalTable: "Procurement_Details",
                        principalColumn: "Procurement_Details_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proof_Of_Payment_Procurement_Details_Procurement_Details_ID",
                        column: x => x.Procurement_Details_ID,
                        principalTable: "Procurement_Details",
                        principalColumn: "Procurement_Details_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Access",
                columns: new[] { "Access_ID", "CanAccFin", "CanAccInv", "CanAccPro", "CanAccRep", "CanAccVen", "CanAppVen", "CanDeleteVen", "CanEditVen", "CanViewFinPro", "CanViewFlagPro", "CanViewPenPro", "IsAdmin" },
                values: new object[] { 1, "true", "true", "true", "true", "true", "true", "true", "true", "true", "true", "true", "true" });
            ...
            migrationBuilder.InsertData(
                table: "Contracted_Partner_Type",
                columns: new[] { "Contracted_Partner_Type_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Controller (C)", "Controller (C)" },
                    { 2, "Joint Controller (JC)", "Joint Controller (JC)" },
                    { 3, "Processor (P)", "Processor (P)" },
                    { 4, "Sub-Processor (SP)", "Sub-Processor (SP)" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Request is created but not active", "Inactive" },
                    { 2, "Request period is active and access is given", "Active" },
                    { 3, "Request period has passed and access revoked", "Revoked" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Help_Category",
                columns: new[] { "Help_Category_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Help related to Vendor activities.", "Vendor" },
                    { 2, "Help related to Finiance activities.", "Finance" },
                    { 3, "Help related to Reporting activities.", "Reports" },
                    { 4, "Help related to Procurement activities.", "Procurment" },
                    { 5, "Help related to Administration activities.", "Administration" },
                    { 6, "Help related to Inventory activities.", "Inventory" }
                });

            migrationBuilder.InsertData(
                table: "Mandate_Limit",
                columns: new[] { "Mandate_ID", "Ammount", "Date" },
                values: new object[] { 1, 10000.0, new DateTime(2023, 8, 16, 16, 41, 43, 367, DateTimeKind.Local).AddTicks(6077) });

            migrationBuilder.InsertData(
                table: "Notification_Type",
                columns: new[] { "Notification_Type_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Please review the request and respond accordingly.", "New Vendor Onboard Request" },
                    { 2, "Please review the request and respond accordingly.", "Vendor BEE renewal" },
                    { 3, "Please review the request and respond accordingly.", "Vendor Review" },
                    { 4, "Please review the product and respond accordingly.", "Low Inventory Stock Level Detected" },
                    { 5, "Please complete the create vendor process to add them to the system.", "Vendor Onboard Request Has Been Accepted" },
                    { 6, "Please contact the relevant person to find rejection reason.", "Vendor Onboard Request Has Been Rejected" },
                    { 7, "Please review the request and respond accordingly.", "New Procurement Request Has Exceeded Budget Allocation" },
                    { 8, "Please proceed by placing the procurement details.", "Procurement Request Has Been Accepted" },
                    { 9, "Please review the request for the relevant reason and respond accordingly.", "Procurement Request Has Been Rejected" },
                    { 10, "Please review the request and respond accordingly.", "New Procurement Request Quote Approval Required." },
                    { 11, "Please review the request and respond accordingly.", "Procurement Request Has Been Approved" },
                    { 12, "Please ensure all items are registered on the system.", "Procurement Request Has Been Finalised" },
                    { 13, "Please procced to add required details for vendor.", "Vendor Sole Supplier Has Been Approved By General Manager" },
                    { 14, "Please review the request and respond accordingly.", "Procurement Details Has Been Flagged" },
                    { 15, "Please review the request and respond accordingly.", "Vendor Onboard Request Requires Management Approval" },
                    { 16, "Please review the request and respond accordingly.", "Flagged Procurement Details Has Been Approved" },
                    { 17, "Please review the request and respond accordingly.", "Flagged Procurement Details Has Been Rejected" },
                    { 18, "Please review the request and respond accordingly.", "New Procurement Request" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Rejected", "Rejected" },
                    { 3, "Approve", "Approve" },
                    { 4, "Requires manging directors approval", "MDRequiredApproval" },
                    { 5, "Request is busy being view", "PendingBusy" }
                });

            migrationBuilder.InsertData(
                table: "Payment_Method",
                columns: new[] { "Payment_Method_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Credit Card Payment", "Credit" },
                    { 2, "Paying with cash", "Cash" },
                    { 3, "Paying with EFT", "EFT" }
                });

            migrationBuilder.InsertData(
                table: "Procurement_Payment_Status",
                columns: new[] { "Procurement_Payment_Status_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Procurement has been paid", "Payed" },
                    { 2, "Payment must still be made", "Awaiting payment" }
                });

            migrationBuilder.InsertData(
                table: "Procurement_Status",
                columns: new[] { "Procurement_Status_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Procurement Details are placed", "Awaiting Delivery" },
                    { 2, "Procurement has been finialized", "Finished" },
                    { 3, "Employee is over allowed mandate limit", "Flagged" },
                    { 4, "Request was Rejected", "Rejected" }
                });

            migrationBuilder.InsertData(
                table: "Requisition_Status",
                columns: new[] { "Requisition_Status_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Accepted", "Accepted (Ready to order)" },
                    { 2, "Rejected", "Rejected" },
                    { 3, "Approval Required", "Approval Required" },
                    { 4, "Request Finalised", "Done" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Sign_Off_Status",
                columns: new[] { "Sign_Off_Status_ID", "Description", "Name" },
                values: new object[] { 1, "Has not been signed off", "No" });
            ...
            migrationBuilder.InsertData(
                table: "Vendor_Insurance_Type",
                columns: new[] { "Vendor_Insurance_Type_ID", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "General liability insurance", "General liability insurance" },
                    { 2, "Cyber insurance", "Cyber insurance" },
                    { 3, "Professional indemnity insurance", "Professional indemnity insurance" },
                    { 4, "Other specific insurance", "Other specific insurance" }
                });
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "User_Id", "Access_ID", "No_Notifications", "Password", "Profile_Picture", "Role_ID", "Username" },
                values: new object[] { 1, 1, 0, "$2a$11$Ju0RyjRF3hnV9CPFbChgeOn/aUiICE7nVcXEz2ALtSG/GQejVlZr2", "test", 2, "Admin" });

            migrationBuilder.InsertData(
                table: "Vendor",
                columns: new[] { "Vendor_ID", "Email", "Name", "Number_Of_Times_Used", "PreferedVendor", "Sole_Supplier_Provided", "Vendor_Status_ID" },
                values: new object[,]
                {
                    { 1, "xxxxxxxxxxxxxxxxxxxxxxxxxxx@xxxx", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", 0, true, false, 2 },
                    { 2, "xxxxxxxxxxxxxxxxxxxxxxxxxxx@xxxx", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx2", 0, true, false, 2 }
                });

            migrationBuilder.InsertData(
                table: "Admin",
                columns: new[] { "Admin_ID", "AdminName", "AdminSurname", "CellPhone_Num", "Email", "User_Id" },
                values: new object[] { 1, "Admin", "Demo", "0793731393", "moyoemailservice@gmail.com", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consumable_History_Consumable_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Delegation_Of_Authority_DelegationStatus_ID",
                table: "Delegation_Of_Authority",
                column: "DelegationStatus_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposit_Procurement_Details_ID",
                table: "Deposit",
                column: "Procurement_Details_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Due_Dillegence_Vendor_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payment_Made_Procurement_Details_ID",
                table: "Payment_Made",
                column: "Procurement_Details_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Asset_Procurement_Details_ID",
                table: "Procurement_Asset",
                column: "Procurement_Details_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Consumable_Procurement_Details_ID",
                table: "Procurement_Consumable",
                column: "Procurement_Details_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_BudgetLineId",
                table: "Procurement_Details",
                column: "BudgetLineId");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_EmployeeID",
                table: "Procurement_Details",
                column: "EmployeeID");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_Payment_Method_ID",
                table: "Procurement_Details",
                column: "Payment_Method_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_Procurement_Payment_Status_ID",
                table: "Procurement_Details",
                column: "Procurement_Payment_Status_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_Procurement_Request_ID",
                table: "Procurement_Details",
                column: "Procurement_Request_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_Procurement_Status_ID",
                table: "Procurement_Details",
                column: "Procurement_Status_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Details_Sign_Off_Status_ID",
                table: "Procurement_Details",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Request_User_ID",
                table: "Procurement_Request",
                column: "User_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Procurement_Request_Quote_Procurement_Request_ID",
                table: "Procurement_Request_Quote",
                column: "Procurement_Request_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Proof_Of_Payment_Procurement_Details_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendor_Consumable_Vendor_ID",
                table: "Vendor_Consumable",
                column: "Vendor_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendor_Insurance_Vendor_ID",
                table: "Vendor_Insurance",
                column: "Vendor_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Vendor_Insurance_Vendor_Insurance_Type_ID",
                table: "Vendor_Insurance",
                column: "Vendor_Insurance_Type_ID");
